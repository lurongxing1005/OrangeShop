			...
			<div class="res-main">
				...
				<div class="login-box">
						...
						<div class="am-tabs" id="doc-my-tabs">
							...
							<div class="am-tabs-bd">
								...
								<span style="color:red">${errorMsg}</span>	
									<form action="/shoppingPro/register" method="post">
                 ...
                 <div class="user-phone">
								    ...
								    <input type="tel" name="" id="phone" placeholder="功能还未开放">
                 </div>																			
										<div class="verification">
											<label for="code"><i class="am-icon-code-fork"></i></label>
											<input type="tel" name="" id="code" placeholder="敬请期待">
											<a class="btn" href="javascript:void(0);" onclick="sendMobileCode();" id="sendMobileCode">
												<span id="dyMobileButton">获取</span></a>
										</div>
                 <div class="user-pass">
								    <label for="password"><i class="am-icon-lock"></i></label>
								    <input type="password" name="" id="password" placeholder="请期待">
                 </div>										
                 <div class="user-pass">
								    <label for="passwordRepeat"><i class="am-icon-lock"></i></label>
								    <input type="password" name="" id="" placeholder="期待">
                 </div>	
									</form>
