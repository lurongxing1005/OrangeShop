...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	...
	<c:choose>
		...
		<div title="公告管理" data-options="selected:true,iconCls:'icon-user'" style="padding: 10px">
			<c:if test="">
			<a href="javascript:openTab('添加公告','noticeManage.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">添加公告</a>
			</c:if>
			<a href="javascript:openTab('查看公告','noticeManage.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">查看公告</a>
		</div>
		<div title="新闻管理" data-options="selected:true,iconCls:'icon-user'" style="padding: 10px">
			<a href="javascript:openTab('新闻管理','alert.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">新闻管理</a>
